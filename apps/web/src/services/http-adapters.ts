...
export function createHttpAdapters(opts: HttpAdapterOptions): Services {
  ...
  return {
    ...
    contacts: { list: (id) => get<ListResult<Contact>>(`${ws(id)}/contacts`) },
    groups: { list: (id) => get<ListResult<Group>>(`${ws(id)}/groups`) },
    segments: { list: (id) => get<ListResult<Segment>>(`${ws(id)}/segments`) },
    inbox: {
    ...
    templates: { list: (id) => get<ListResult<Template>>(`${ws(id)}/templates`) },
